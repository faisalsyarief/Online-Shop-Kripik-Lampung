<?php $this->load->view('backend/header') ?>
	<div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="text-center">Laporan Pembayaran CV. Surya Kencana</small></h3>
            <ol class="breadcrumb">
              <?=anchor('admin/reports/search','<i class="glyphicon glyphicon-search"></i> Cari Laporan',['class'=>'btn btn-primary btn-xs'])?>
